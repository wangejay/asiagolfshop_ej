...
jQuery(document).ready(function($){
       ...
       $('#wdm_mult_chk_del').live("click",function(){ 
        ...
        if(aaucs == '' || aaucs == null){
            alert('<?php _e("Please select invoice(s) to delete.", "wdm-ultimate-auction");?>');
            return false;
        }
        else
            var cnf = confirm('<?php _e("Are you sure to delete the selected invoice entries?", "wdm-ultimate-auction");?>');
