...
<?php
	...
	if(isset($_POST['wdm_paypal_address'])){
	    update_option('wdm_paypal_address', $_POST['wdm_paypal_address']);
	}
	
	if(isset($_POST['wdm_account_mode'])){
	    update_option('wdm_account_mode', $_POST['wdm_account_mode']);
	}
	...
	if(isset($_POST['wdm_wire_transfer'])){
	    update_option('wdm_wire_transfer', $_POST['wdm_wire_transfer']);
	}
	...
	if(isset($_POST['wdm_mailing_address'])){
	    update_option('wdm_mailing_address', $_POST['wdm_mailing_address']);
	}
