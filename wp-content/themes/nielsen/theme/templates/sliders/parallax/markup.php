...
$autoplay = ( $autoplay ) ? ( 'data-autoplay="' . $autoplay_speed . '"' ) : '';
$transition = ( isset( $transition_speed ) ) ? ( 'data-transition="' . $transition_speed . '"' ) : '';
?>
<!-- BEGIN PARALLAX SLIDER -->
<div id="<?php echo esc_attr( $slider_id ) ?>"<?php $slider->item_class( $slider_class ) ?> style="<?php echo esc_attr( $width_inline ); ?><?php echo esc_attr( $height_inline ); ?>" <?php echo esc_attr( $autoplay.' '.$transition )?>>
