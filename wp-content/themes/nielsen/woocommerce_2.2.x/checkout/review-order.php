...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<div id="payment">
        <h2><?php _e('Payment Methods', 'yit'); ?></h2>
			...
			<?php
				...
				if ( ! empty( $available_gateways ) ) {
					...
					foreach ( $available_gateways as $gateway ) {
						?>
						<li class="payment_method_<?php echo $gateway->id; ?> border">
		...
		<div class="form-row place-order border">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="btn btn-flat-red" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
