        ...
        <?php if ( ! empty( $available_variations ) ) : ?>
            <ul class="variations" cellspacing="0">
                ...
                <?php $loop = 0; foreach ( $attributes as $name => $options ) : $loop ++; ?>
                    <li>
                        ...
                        <select id="<?php echo esc_attr( sanitize_title( $name ) ); ?>" name="attribute_<?php echo esc_attr( sanitize_title( $name ) ); ?>" data-type="<?php echo esc_attr( $attributes_types[$name] ); ?>">
            ...
            <div class="single_variation_wrap" style="display:none;">
                ...
                <div class="variations_button group">
                    ...
                    <?php do_action( 'woocommerce_before_add_to_cart_button' ); ?>
                    <button type="submit" class="single_add_to_cart_button btn btn-flat-red"><?php echo apply_filters( 'add_to_cart_text', $product->single_add_to_cart_text() ); ?></button>
                </div>
